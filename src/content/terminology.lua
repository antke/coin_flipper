...
Terminology.terms = {
  ...
  purse = { label = "Purse", lower = "purse", plural = "purses" },
  ...
  head_weight = { label = "Head Weight", lower = "Head weight", plural = "Head Weights" },
  heads_weight = { label = "Heads Weight", lower = "Heads weight", plural = "Heads Weights" },
  tail_weight = { label = "Tail Weight", lower = "Tail weight", plural = "Tail Weights" },
  tails_weight = { label = "Tails Weight", lower = "Tails weight", plural = "Tails Weights" },
  stage_score = { label = "Stage Score", lower = "stage score", plural = "Stage Scores" },
  run_score = { label = "Run Score", lower = "run score", plural = "Run Scores" },
...
Terminology.textReplacements = {
  ...
  { from = "Heads weight", to = labelTerm("heads_weight") },
  { from = "Tails weight", to = labelTerm("tails_weight") },
  { from = "stage score", to = labelTerm("stage_score") },
  { from = "run score", to = labelTerm("run_score") },
