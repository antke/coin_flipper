...
local EncounterDefinitions = {
  ...
  },
  {
    ...
    choices = {
      {
        id = "mirror_echo_penny_choice",
        type = "coin",
        contentId = "echo_penny",
        label = "Take Echo Penny",
        description = "Add Echo Penny to your run collection.",
      },
      {
  ...
  },
  {
    ...
    familyId = "momentum",
    name = "Momentum Booth",
    description = "A streak-minded bookie offers a tails coin or a cleaner repeated-call payoff.",
    choices = {
      {
        id = "momentum_moon_mint",
        type = "coin",
        contentId = "moon_mint",
        label = "Take Moon Mint",
        description = "Add Moon Mint to your run collection.",
      },
      {
        id = "momentum_pressure_valve",
        type = "upgrade",
        contentId = "pressure_valve",
        label = "Take Pressure Valve",
        description = "Gain Pressure Valve for the run.",
      },
    },
  },
}
